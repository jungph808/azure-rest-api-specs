...
{
    /// <summary> The Bookmark service client. </summary>
    public partial class BookmarkClient
    {
        ...
        /// <summary> Initializes a new instance of BookmarkClient for mocking. </summary>
        protected BookmarkClient()
        {
        }

        /// <summary> Initializes a new instance of BookmarkClient. </summary>
        ...
        public BookmarkClient(string subscriptionId, TokenCredential credential) : this(subscriptionId, credential, new Uri("https://management.azure.com"), new SecurityInsightsClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public BookmarkClient(string subscriptionId, TokenCredential credential, Uri endpoint, SecurityInsightsClientOptions options)
        {
        ...
        /// Request Body:
        /// 
        /// Schema for <c>BookmarkExpandParameters</c>:
        /// <code>{
        ///   endTime: string (ISO 8601 Format), # Optional. The end date filter, so the only expansion results returned are before this date.
        ///   expansionId: BookmarkExpandParametersExpansionId, # Optional. The Id of the expansion to perform.
        ...
        /// Response Body:
        /// 
        /// Schema for <c>BookmarkExpandResponse</c>:
        /// <code>{
        ///   metaData: {
        ///     aggregations: [
        ///       {
        ...
        ///     edges: [
        ///       {
        ///         targetEntityId: string, # Optional. Entity Id of the connected entity
        ///         additionalData: AnyObject, # Optional. key-value pairs for a connected entity mapping
        ///       }
        ///     ], # Optional. Array of expansion result connected entities
        ///   }, # Optional. The expansion result values.
        /// }
        /// </code>
        /// 
        /// </remarks>
        public virtual async Task<Response> ExpandAsync(string resourceGroupName, string workspaceName, string bookmarkId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("BookmarkClient.Expand");
            scope.Start();
            try
            {
                using HttpMessage message = CreateExpandRequest(resourceGroupName, workspaceName, bookmarkId, content, context);
        ...
        /// 
        /// </remarks>
        public virtual Response Expand(string resourceGroupName, string workspaceName, string bookmarkId, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(workspaceName, nameof(workspaceName));
            Argument.AssertNotNullOrEmpty(bookmarkId, nameof(bookmarkId));
        ...
        internal HttpMessage CreateExpandRequest(string resourceGroupName, string workspaceName, string bookmarkId, RequestContent content, RequestContext context)
        {
