...
{
    /// <summary> The Actions service client. </summary>
    public partial class ActionsClient
    {
        ...
        /// <summary> Initializes a new instance of ActionsClient for mocking. </summary>
        protected ActionsClient()
        {
        }

        /// <summary> Initializes a new instance of ActionsClient. </summary>
        ...
        public ActionsClient(string subscriptionId, TokenCredential credential) : this(subscriptionId, credential, new Uri("https://management.azure.com"), new SecurityInsightsClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public ActionsClient(string subscriptionId, TokenCredential credential, Uri endpoint, SecurityInsightsClientOptions options)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="workspaceName"/>, <paramref name="ruleId"/> or <paramref name="actionId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="resourceGroupName"/>, <paramref name="workspaceName"/>, <paramref name="ruleId"/> or <paramref name="actionId"/> is an empty string, and was expected to be non-empty. </exception>
        ...
        ///     workflowId: string, # Optional. The name of the logic app&apos;s workflow.
        ///   }, # Optional. Action properties for get request
        /// }
        /// </code>
        /// 
        /// </remarks>
        public virtual async Task<Response> GetActionAsync(string resourceGroupName, string workspaceName, string ruleId, string actionId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ActionsClient.GetAction");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetActionRequest(resourceGroupName, workspaceName, ruleId, actionId, context);
        ...
        /// 
        /// </remarks>
        public virtual Response GetAction(string resourceGroupName, string workspaceName, string ruleId, string actionId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(workspaceName, nameof(workspaceName));
            Argument.AssertNotNullOrEmpty(ruleId, nameof(ruleId));
        ...
        /// <param name="context"> The request context, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="workspaceName"/>, <paramref name="ruleId"/>, <paramref name="actionId"/> or <paramref name="content"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="resourceGroupName"/>, <paramref name="workspaceName"/>, <paramref name="ruleId"/> or <paramref name="actionId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <remarks>
        ...
        ///   properties: {
        ///     logicAppResourceId: string, # Required. Logic App Resource Id, /subscriptions/{my-subscription}/resourceGroups/{my-resource-group}/providers/Microsoft.Logic/workflows/{my-workflow-id}.
        ///     triggerUri: string, # Required. Logic App Callback URL for this specific workflow.
        ///   }, # Optional. Action properties for put request
        /// }
        /// </code>
        /// 
        /// Response Body:
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> CreateOrUpdateAsync(string resourceGroupName, string workspaceName, string ruleId, string actionId, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(workspaceName, nameof(workspaceName));
            Argument.AssertNotNullOrEmpty(ruleId, nameof(ruleId));
            ...
            using var scope = ClientDiagnostics.CreateScope("ActionsClient.CreateOrUpdate");
            scope.Start();
            try
            {
                using HttpMessage message = CreateCreateOrUpdateRequest(resourceGroupName, workspaceName, ruleId, actionId, content, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// 
        /// </remarks>
        public virtual Response CreateOrUpdate(string resourceGroupName, string workspaceName, string ruleId, string actionId, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(workspaceName, nameof(workspaceName));
            Argument.AssertNotNullOrEmpty(ruleId, nameof(ruleId));
        ...
        public virtual async Task<Response> DeleteAsync(string resourceGroupName, string workspaceName, string ruleId, string actionId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(workspaceName, nameof(workspaceName));
            Argument.AssertNotNullOrEmpty(ruleId, nameof(ruleId));
            ...
            using var scope = ClientDiagnostics.CreateScope("ActionsClient.Delete");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDeleteRequest(resourceGroupName, workspaceName, ruleId, actionId, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual Response Delete(string resourceGroupName, string workspaceName, string ruleId, string actionId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(workspaceName, nameof(workspaceName));
            Argument.AssertNotNullOrEmpty(ruleId, nameof(ruleId));
        ...
        /// Response Body:
        /// 
        /// Schema for <c>ActionsListValue</c>:
        /// <code>{
        ///   etag: string, # Optional. Etag of the azure resource
        ///   id: string, # Optional. Fully qualified resource ID for the resource. Ex - /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}
        ///   name: string, # Optional. The name of the resource
        ...
        /// 
        /// </remarks>
        public virtual AsyncPageable<BinaryData> GetActionsByAlertRuleAsync(string resourceGroupName, string workspaceName, string ruleId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(workspaceName, nameof(workspaceName));
            Argument.AssertNotNullOrEmpty(ruleId, nameof(ruleId));

            return GetActionsByAlertRuleImplementationAsync("ActionsClient.GetActionsByAlertRule", resourceGroupName, workspaceName, ruleId, context);
        }

        private AsyncPageable<BinaryData> GetActionsByAlertRuleImplementationAsync(string diagnosticsScopeName, string resourceGroupName, string workspaceName, string ruleId, RequestContext context)
        {
            ...
            async IAsyncEnumerable<Page<BinaryData>> CreateEnumerableAsync(string nextLink, int? pageSizeHint, [EnumeratorCancellation] CancellationToken cancellationToken = default)
            {
                do
                {
                    var message = string.IsNullOrEmpty(nextLink)
                        ? CreateGetActionsByAlertRuleRequest(resourceGroupName, workspaceName, ruleId, context)
                        : CreateGetActionsByAlertRuleNextPageRequest(nextLink, resourceGroupName, workspaceName, ruleId, context);
        ...
        /// 
        /// </remarks>
        public virtual Pageable<BinaryData> GetActionsByAlertRule(string resourceGroupName, string workspaceName, string ruleId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(workspaceName, nameof(workspaceName));
            Argument.AssertNotNullOrEmpty(ruleId, nameof(ruleId));

            return GetActionsByAlertRuleImplementation("ActionsClient.GetActionsByAlertRule", resourceGroupName, workspaceName, ruleId, context);
        }

        private Pageable<BinaryData> GetActionsByAlertRuleImplementation(string diagnosticsScopeName, string resourceGroupName, string workspaceName, string ruleId, RequestContext context)
        {
        ...
        internal HttpMessage CreateGetActionsByAlertRuleRequest(string resourceGroupName, string workspaceName, string ruleId, RequestContext context)
        {
        ...
        internal HttpMessage CreateGetActionRequest(string resourceGroupName, string workspaceName, string ruleId, string actionId, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string resourceGroupName, string workspaceName, string ruleId, string actionId, RequestContent content, RequestContext context)
        {
        ...
        internal HttpMessage CreateDeleteRequest(string resourceGroupName, string workspaceName, string ruleId, string actionId, RequestContext context)
        {
        ...
        internal HttpMessage CreateGetActionsByAlertRuleNextPageRequest(string nextLink, string resourceGroupName, string workspaceName, string ruleId, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
