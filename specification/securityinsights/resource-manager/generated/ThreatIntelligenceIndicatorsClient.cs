...
{
    /// <summary> The ThreatIntelligenceIndicators service client. </summary>
    public partial class ThreatIntelligenceIndicatorsClient
    {
        ...
        /// <summary> Initializes a new instance of ThreatIntelligenceIndicatorsClient for mocking. </summary>
        protected ThreatIntelligenceIndicatorsClient()
        {
        }

        /// <summary> Initializes a new instance of ThreatIntelligenceIndicatorsClient. </summary>
        ...
        public ThreatIntelligenceIndicatorsClient(string subscriptionId, TokenCredential credential) : this(subscriptionId, credential, new Uri("https://management.azure.com"), new SecurityInsightsClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public ThreatIntelligenceIndicatorsClient(string subscriptionId, TokenCredential credential, Uri endpoint, SecurityInsightsClientOptions options)
        {
        ...
        /// 
        /// </remarks>
        public virtual AsyncPageable<BinaryData> GetThreatIntelligenceIndicatorsAsync(string resourceGroupName, string workspaceName, string filter = null, string orderby = null, int? top = null, string skipToken = null, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(workspaceName, nameof(workspaceName));

            return GetThreatIntelligenceIndicatorsImplementationAsync("ThreatIntelligenceIndicatorsClient.GetThreatIntelligenceIndicators", resourceGroupName, workspaceName, filter, orderby, top, skipToken, context);
        }

        private AsyncPageable<BinaryData> GetThreatIntelligenceIndicatorsImplementationAsync(string diagnosticsScopeName, string resourceGroupName, string workspaceName, string filter, string orderby, int? top, string skipToken, RequestContext context)
        {
            ...
            async IAsyncEnumerable<Page<BinaryData>> CreateEnumerableAsync(string nextLink, int? pageSizeHint, [EnumeratorCancellation] CancellationToken cancellationToken = default)
            {
                do
                {
                    var message = string.IsNullOrEmpty(nextLink)
                        ? CreateGetThreatIntelligenceIndicatorsRequest(resourceGroupName, workspaceName, filter, orderby, top, skipToken, context)
                        : CreateGetThreatIntelligenceIndicatorsNextPageRequest(nextLink, resourceGroupName, workspaceName, filter, orderby, top, skipToken, context);
        ...
        /// 
        /// </remarks>
        public virtual Pageable<BinaryData> GetThreatIntelligenceIndicators(string resourceGroupName, string workspaceName, string filter = null, string orderby = null, int? top = null, string skipToken = null, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(workspaceName, nameof(workspaceName));

            return GetThreatIntelligenceIndicatorsImplementation("ThreatIntelligenceIndicatorsClient.GetThreatIntelligenceIndicators", resourceGroupName, workspaceName, filter, orderby, top, skipToken, context);
        }

        private Pageable<BinaryData> GetThreatIntelligenceIndicatorsImplementation(string diagnosticsScopeName, string resourceGroupName, string workspaceName, string filter, string orderby, int? top, string skipToken, RequestContext context)
        {
        ...
        internal HttpMessage CreateGetThreatIntelligenceIndicatorsRequest(string resourceGroupName, string workspaceName, string filter, string orderby, int? top, string skipToken, RequestContext context)
        {
        ...
        internal HttpMessage CreateGetThreatIntelligenceIndicatorsNextPageRequest(string nextLink, string resourceGroupName, string workspaceName, string filter, string orderby, int? top, string skipToken, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
