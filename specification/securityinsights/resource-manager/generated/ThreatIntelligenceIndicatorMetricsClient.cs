...
{
    /// <summary> The ThreatIntelligenceIndicatorMetrics service client. </summary>
    public partial class ThreatIntelligenceIndicatorMetricsClient
    {
        ...
        /// <summary> Initializes a new instance of ThreatIntelligenceIndicatorMetricsClient for mocking. </summary>
        protected ThreatIntelligenceIndicatorMetricsClient()
        {
        }

        /// <summary> Initializes a new instance of ThreatIntelligenceIndicatorMetricsClient. </summary>
        ...
        public ThreatIntelligenceIndicatorMetricsClient(string subscriptionId, TokenCredential credential) : this(subscriptionId, credential, new Uri("https://management.azure.com"), new SecurityInsightsClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public ThreatIntelligenceIndicatorMetricsClient(string subscriptionId, TokenCredential credential, Uri endpoint, SecurityInsightsClientOptions options)
        {
        ...
        /// Response Body:
        /// 
        /// Schema for <c>ThreatIntelligenceMetricsList</c>:
        /// <code>{
        ///   value: [
        ///     {
        ///       properties: {
        ///         lastUpdatedTimeUtc: string, # Optional. Last updated indicator metric
        ///         threatTypeMetrics: [
        ///           {
        ///             metricName: string, # Optional. Metric name
        ///             metricValue: number, # Optional. Metric value
        ///           }
        ///         ], # Optional. Threat type metrics
        ///         patternTypeMetrics: [ThreatIntelligenceMetricEntity], # Optional. Pattern type metrics
        ///         sourceMetrics: [ThreatIntelligenceMetricEntity], # Optional. Source metrics
        ///       }, # Optional. Threat intelligence metrics.
        ///     }
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> GetThreatIntelligenceIndicatorMetricsAsync(string resourceGroupName, string workspaceName, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(workspaceName, nameof(workspaceName));

            using var scope = ClientDiagnostics.CreateScope("ThreatIntelligenceIndicatorMetricsClient.GetThreatIntelligenceIndicatorMetrics");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetThreatIntelligenceIndicatorMetricsRequest(resourceGroupName, workspaceName, context);
        ...
        /// 
        /// </remarks>
        public virtual Response GetThreatIntelligenceIndicatorMetrics(string resourceGroupName, string workspaceName, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(workspaceName, nameof(workspaceName));
        ...
        internal HttpMessage CreateGetThreatIntelligenceIndicatorMetricsRequest(string resourceGroupName, string workspaceName, RequestContext context)
        {
