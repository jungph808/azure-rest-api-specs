...
{
    /// <summary> The EntitiesRelations service client. </summary>
    public partial class EntitiesRelationsClient
    {
        ...
        /// <summary> Initializes a new instance of EntitiesRelationsClient for mocking. </summary>
        protected EntitiesRelationsClient()
        {
        }

        /// <summary> Initializes a new instance of EntitiesRelationsClient. </summary>
        ...
        public EntitiesRelationsClient(string subscriptionId, TokenCredential credential) : this(subscriptionId, credential, new Uri("https://management.azure.com"), new SecurityInsightsClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public EntitiesRelationsClient(string subscriptionId, TokenCredential credential, Uri endpoint, SecurityInsightsClientOptions options)
        {
        ...
        /// 
        /// </remarks>
        public virtual AsyncPageable<BinaryData> GetEntitiesRelationsAsync(string resourceGroupName, string workspaceName, string entityId, string filter = null, string orderby = null, int? top = null, string skipToken = null, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(workspaceName, nameof(workspaceName));
            Argument.AssertNotNullOrEmpty(entityId, nameof(entityId));

            return GetEntitiesRelationsImplementationAsync("EntitiesRelationsClient.GetEntitiesRelations", resourceGroupName, workspaceName, entityId, filter, orderby, top, skipToken, context);
        }

        private AsyncPageable<BinaryData> GetEntitiesRelationsImplementationAsync(string diagnosticsScopeName, string resourceGroupName, string workspaceName, string entityId, string filter, string orderby, int? top, string skipToken, RequestContext context)
        {
            ...
            async IAsyncEnumerable<Page<BinaryData>> CreateEnumerableAsync(string nextLink, int? pageSizeHint, [EnumeratorCancellation] CancellationToken cancellationToken = default)
            {
                do
                {
                    var message = string.IsNullOrEmpty(nextLink)
                        ? CreateGetEntitiesRelationsRequest(resourceGroupName, workspaceName, entityId, filter, orderby, top, skipToken, context)
                        : CreateGetEntitiesRelationsNextPageRequest(nextLink, resourceGroupName, workspaceName, entityId, filter, orderby, top, skipToken, context);
        ...
        /// 
        /// </remarks>
        public virtual Pageable<BinaryData> GetEntitiesRelations(string resourceGroupName, string workspaceName, string entityId, string filter = null, string orderby = null, int? top = null, string skipToken = null, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(workspaceName, nameof(workspaceName));
            Argument.AssertNotNullOrEmpty(entityId, nameof(entityId));

            return GetEntitiesRelationsImplementation("EntitiesRelationsClient.GetEntitiesRelations", resourceGroupName, workspaceName, entityId, filter, orderby, top, skipToken, context);
        }

        private Pageable<BinaryData> GetEntitiesRelationsImplementation(string diagnosticsScopeName, string resourceGroupName, string workspaceName, string entityId, string filter, string orderby, int? top, string skipToken, RequestContext context)
        {
        ...
        internal HttpMessage CreateGetEntitiesRelationsRequest(string resourceGroupName, string workspaceName, string entityId, string filter, string orderby, int? top, string skipToken, RequestContext context)
        {
        ...
        internal HttpMessage CreateGetEntitiesRelationsNextPageRequest(string nextLink, string resourceGroupName, string workspaceName, string entityId, string filter, string orderby, int? top, string skipToken, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
